...
export interface UserServiceClient {
  ...
  queryUsers(request: Observable<QueryUsersRequest>): Observable<QueryUsersResponse>;
}
...
export interface UserServiceController {
  ...
  ): Promise<RemoveUserResponse> | Observable<RemoveUserResponse> | RemoveUserResponse;
